...
abstract mixin class $TodoCopyWith<$Res> {
  factory $TodoCopyWith(Todo value, $Res Function(Todo) _then) =
      _$TodoCopyWithImpl;
  @useResult
  $Res call({int id, String title, String? memo, bool isCompleted});
}
...
extension TodoPatterns on Todo {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, String title, String? memo, bool isCompleted)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Todo() when $default != null:
        return $default(_that.id, _that.title, _that.memo, _that.isCompleted);
      case _:
        return orElse();
    }
  }
